...
export const productTree: ProductNode[] = [
  {
    ...
    name: "외경 CAP",
    description:
      "병/파이프의 외경에 끼우는 캡류. PVC와 PE 두 가지 소재 기반 제품을 생산합니다.",
    children: [
      {
        slug: "pvc",
        name: "PVC CAP",
  ...
  },
  {
    ...
    name: "내경 CAP",
    description:
      "파이프/호스의 내경에 삽입하는 캡류. 나사 TYPE, DUST CAP, PIPE END CAP 등.",
    children: [
      {
        slug: "screw",
        name: "나사 TYPE",
...
export const faqs = [
  { id: 1, q: "제품문의는 어떻게 하나요?", a: "제품정보란에 사진 및 치수 확인이 가능하며, 피팅이나 상대물을 보내주시면 거기에 맞는 CAP을 추천해 드릴수도 있습니다." },
  { id: 2, q: "제품 개발도 가능한가요?", a: "금형 개발도 가능하며, 제작기간은 45~60일 정도 소요예상됩니다." },
  { id: 3, q: "PVC캡 제작시 길이(L) 및 두께(T) 조절이 가능한가요?", a: "길이(L) 및 두께 조절 가능합니다." },
  { id: 4, q: "PVC캡 색상은 어떻게 되나요?", a: "검정/투명/적색이 기본 색상입니다." },
  { id: 5, q: "사출(PE) 캡 색상은 어떻게 되나요?", a: "투명/백색/적색/청색/검정이 기본 색상입니다." },
