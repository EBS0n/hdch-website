        ...
        <Container>
          ...
          <div className="mt-32 sm:mt-40">
            <article className="text-ink-700 leading-loose space-y-5 text-[14px] sm:text-[15px]">
              ...
              <p>
                현대화학은 1987년 설립, 신발 부품으로 시작하여, 90년대 자동차 에어컨,
                브레이크, 스티어링 부품의 청정도 유지 및 충격 방지용 캡으로 확대하였고,
                90년대 후반 DIPPING CAP 설비를 추가하여 각종 유압 설비 및 건설 중장비의
                유압 부품 품질 관리용 마개류를 전문으로 하는 기업으로 성장해 왔습니다.
              </p>
              <p>
                플라스틱 캡이라는 작은 부품 하나하나가 고객사 제품의 품질과 신뢰성을
                좌우한다는 신념으로, 사출 설비와 DIPPING 설비의 자동화 및
                정밀 측정 품질 장비를 꾸준히 확충하였습니다.
              </p>
              <p>
                2005년, ISO9001과 CLEAN 사업장 인증 이후로도 지속적으로 품질 및
                생산 공정을 개선하였으며, 2017년 현재 대표의 취임 후,
                <br />
                2021년 현 위치로 이전하며 품질과 생산 능력을 지속적으로 개선하였습니다.
              </p>
              <p>
